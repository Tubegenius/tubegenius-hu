...
| Trend Alerts: keyword/category/competitor monitor, gyakoriság | Tracked Trends + Trend Alerts | Trendenként napi/heti/kikapcsolt gyakoriság, összehasonlítható snapshotokból mért VPH-gyorsulás/lassulás és competitor napi VPH-mérés megvan. Közvetlen competitor-riasztás egyedi VPH-küszöbbel még nincs. | részleges, trend-oldal igazolt |
