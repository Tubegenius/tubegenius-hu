...
**Utolsó commit**: [b1257fc] `feat: Channel Header Card + csatorna-első onboarding (channel_usage_mode)` — COMMITOLVA, migráció [029](supabase/migrations/029_channel_profile_and_usage_mode.sql) élesben lefuttatva és élőben megerősítve (ld. "2026-07-13" szakasz lent). Ezt megelőzően: Phase 1 lezárva, teljes Phase 2, Launch Readiness Audit+Hotfix Sprint, Beta Hardening Test, funkció-bejárás 11/28 tétele — mind commitolva (`8ddcdcf`, `9b68574`, `ec9bca5`, `6915997`).
