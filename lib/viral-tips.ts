...
export const viralTips: ViralTip[] = [
  ...
  { id: "strategy_005", category: "strategy", title: "Ne akkor keress témát, amikor már posztolni kell.", body: "A jó videók előbb téma- és hookdöntésből születnek. Ha kapkodva választasz témát, a gyártás is gyengébb lesz.", action: "Ments el legalább 5 témát Creator Memory-ba, mielőtt gyártani kezdesz.", appliesTo: ["tiktok", "shorts", "reels", "youtube"], level: "beginner" },
]
