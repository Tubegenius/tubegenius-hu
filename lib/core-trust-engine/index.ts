...
export function toOpportunityTopic(
  ...
  return {
    ...
    evidence_strength: candidate.decision.evidence_strength,
    validation_reason: candidate.decision.validation_reason,
    recommended_next_action: candidate.decision.recommended_next_action,
    data_limitations: candidate.decision.data_limitations,
